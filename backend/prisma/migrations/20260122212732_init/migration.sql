...
CREATE TABLE "new_Career" (
    ...
    "internationalCategory" TEXT,
    "isChangedClub" BOOLEAN NOT NULL DEFAULT false,
    "aboutClubChanging" TEXT,
    "category" TEXT,
...
INSERT INTO "new_Career" ("aboutInternationalSelection", "category", "clubId", "clubLogo", "competition", "competitionLogo", "endDate", "id", "internationalCategory", "internationalTeamName", "isCaptain", "isChampionWinner", "isInternationalPlayer", "isUpgraded", "nameOfChampionship", "playerId", "season", "startDate") SELECT "aboutInternationalSelection", "category", "clubId", "clubLogo", "competition", "competitionLogo", "endDate", "id", "internationalCategory", "internationalTeamName", "isCaptain", "isChampionWinner", "isInternationalPlayer", "isUpgraded", "nameOfChampionship", "playerId", "season", "startDate" FROM "Career";
DROP TABLE "Career";
