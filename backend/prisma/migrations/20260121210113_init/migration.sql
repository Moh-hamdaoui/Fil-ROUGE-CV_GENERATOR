...
INSERT INTO "new_Career" ("aboutInternationalSelection", "clubId", "clubLogo", "competition", "competitionLogo", "endDate", "id", "internationalTeamName", "isCaptain", "isChampionWinner", "isInternationalPlayer", "nameOfChampionship", "playerId", "season", "startDate") SELECT "aboutInternationalSelection", "clubId", "clubLogo", "competition", "competitionLogo", "endDate", "id", "internationalTeamName", "isCaptain", "isChampionWinner", "isInternationalPlayer", "nameOfChampionship", "playerId", "season", "startDate" FROM "Career";
DROP TABLE "Career";
